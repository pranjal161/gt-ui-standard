...
import ActivitiesList from 'components/Activity/PersonView/Header/ActivitiesList/ActivitiesList';
import HeaderInformation from 'components/Activity/PersonView/Header/HeaderInformation/HeaderInformation';
...
const Header: React.FC<HeaderProps> = (props: HeaderProps) => {
    ...
    if (response && !operationHRef) {
        response.data._links['cscaia:operations'] && setOperationHRef(response.data._links['cscaia:operations'].href)
    }
